<div align="center">
  ...
  <h2><strong>CS2-AntiVPN</strong></h2>
  <h3>Detect & punish vpn usage</h3>
</div>
...
- Start server & configure plugin config in `addons/swiftlys2/configs/plugins/CS2_AntiVPN/config.jsonc`
